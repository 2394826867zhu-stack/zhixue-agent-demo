  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-5 md:space-y-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">全局视角，掌握你的成长轨�?/p>
      </div>

      {/* Key stats */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
        {[
          { label: "本周学习", value: `${weekMinutes}min`, sub: "较上�?+12%", icon: Clock, color: "text-primary" },
          { label: "连续学习", value: "14�?, sub: "保持纪录", icon: Flame, color: "text-orange-500" },
          { label: "总掌握率", value: `${masteryRate}%`, sub: `${totalMastered}/${totalKPs} 知识点`, icon: Brain, color: "text-green-600" },
          { label: "本周闪卡", value: "108�?, sub: "较上�?+22�?, icon: TrendingUp, color: "text-blue-600" },
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2">
            <Calendar size={16} className="text-primary" /> 学习热力图（�?65天）
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">本月周趋�?/CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={180}>
              ...
              <div key={s.subject} className="space-y-1.5">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center gap-3 text-xs text-muted-foreground">
                    ...
                    <span className="text-primary">复习�?{s.reviewing}</span>
                    <span className="text-amber-600">学习�?{s.learning}</span>
