...
const MOCK_NOTES: Note[] = [
  { id: "1", title: "等差数列与等比数�?, subject: "数学", summary: "等差数列公差恒定，等比数列公比恒定。求和公式推导及应用场景对比分析�?, kp_count: 8, created_at: "2026-05-16" },
    ...
    <div className="space-y-5 max-w-2xl">
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {/* Topic */}
          <div>
            <label className="text-sm font-medium text-foreground mb-2 block">主题或内�?/label>
            <textarea
              value={topic}
      ...
      <div className="p-4 rounded-xl border border-dashed border-border bg-muted/30 space-y-2">
        <p className="text-xs font-medium text-foreground">💡 生成效果更好的技�?/p>
        <ul className="text-xs text-muted-foreground space-y-1 list-disc list-inside">
          <li>可以直接粘贴课本段落，AI 会提炼重�?/li>
          <li>具体的主题比宽泛的主题效果更�?/li>
          <li>生成后可�?我的笔记"查看并继续补�?/li>
        </ul>
      </div>
    </div>
  );
