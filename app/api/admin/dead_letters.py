...
@router.get("/dead-letters", summary="死信队列（失败任务）列表", response_model=Envelope[list[dict]])
...
@router.post("/dead-letters/{entry_id}/resolve", summary="标记死信任务已处理", response_model=Envelope[dict])
